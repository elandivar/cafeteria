...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('stocktaking') }}'><i class='nav-icon la la-cash-register'></i> Cierre caja</a></li>
...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('supplier') }}'><i class='nav-icon la la-warehouse'></i> Proveedoees</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('supplier-request') }}'><i class='nav-icon la la-shipping-fast'></i> Pedidos</a></li>
